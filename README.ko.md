...
현재 태그: [`v0.0.3`](https://github.com/bytonylee/mac-whisper/releases/tag/v0.0.3)

`v0.0.3` 릴리스에는 푸시 투 톡 받아쓰기, 플로팅 전사 HUD, 언어 선택, 선택적
LLM 정리, 로컬 빌드 스크립트, DMG 패키징, 홀드 중 재시작 수정, 권한 UX
새로고침이 포함되어 있습니다.
