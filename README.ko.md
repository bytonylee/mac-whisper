...
현재 태그: [`v0.0.4`](https://github.com/bytonylee/mac-whisper/releases/tag/v0.0.4)

`v0.0.4` 릴리스에는 Fn 키를 누른 상태에서 긴 무음이 있어도 받아쓰기 내용을
보존하는 세션 메모리, 무음 경계 이후 음성 인식 재시작, HUD와 최종 붙여넣기
텍스트의 일관된 누적 처리, 첫 녹음 지연을 줄이는 내장 마이크 사전 준비가
포함되어 있습니다.
