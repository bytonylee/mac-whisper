...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.0.4-111111?style=flat-square" alt="Version 0.0.4">
...
Current tag: [`v0.0.4`](https://github.com/bytonylee/mac-whisper/releases/tag/v0.0.4)

The `v0.0.4` release preserves dictation across long pauses while Fn is held,
keeps the HUD and final pasted text backed by the same session memory,
restarts speech recognition after silence boundaries, and prewarms the built-in
input device to reduce first-recording latency.
